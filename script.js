...
@media (max-width: 480px) {
    .logo { font-size: 1.75rem; gap: 6px; }
    .logo .logo-img { height: 32px; }
    .logo .logo-text { font-size: 1.75rem; }
}
.back-btn {
...
/* ============================================================
   BETIX STABILITY — NAVIGATION & EVENT RENDERING
   ============================================================ */
.bottom-nav { z-index: 9999; pointer-events: auto; }
.bottom-nav .nav-item { pointer-events: auto; touch-action: manipulation; -webkit-tap-highlight-color: transparent; }
.sidebar { z-index: 10001; }
.overlay { z-index: 10000; }
.event-card-classic, .event-card-classic * { -webkit-tap-highlight-color: transparent; }
.event-card-classic .poster-wrapper-classic { width: 100%; min-height: 340px; }
.event-card-classic .poster-wrapper-classic img { display: block; width: 100%; height: 100%; min-height: 340px; max-height: 520px; object-fit: cover; object-position: center; }
@media (max-width: 600px) {
  .event-card-classic .poster-wrapper-classic { min-height: 360px; max-height: none; }
  .event-card-classic .poster-wrapper-classic img { min-height: 360px; max-height: 560px; }
}


/* ============================================================
   FINAL NAVIGATION + CENTERED PI CONNECTION NOTIFICATIONS
   These rules intentionally come last to override older duplicated
   notification styles without changing the application structure.
   ============================================================ */
.sidebar-item,
.sidebar-notif-icon-top,
.close-sidebar,
...
.sidebar-item { pointer-events: auto !important; }
.sidebar-nav { pointer-events: auto !important; }
.sidebar.open { pointer-events: auto !important; }
.overlay.active { pointer-events: auto !important; }

/* Professional centered notification for connection/disconnection */
.toast-notification {
    ...
    border: 1px solid rgba(11,31,92,.14) !important;
    border-left: 5px solid #0B1F5C !important;
    border-radius: 20px !important;
    padding: 18px 20px !important;
    background: rgba(255,255,255,.98) !important;
    box-shadow: 0 24px 70px rgba(8,20,63,.28), 0 4px 18px rgba(0,0,0,.08) !important;
...
.toast-notification .toast-icon {
    ...
    color: #fff !important;
    background: #0B1F5C !important;
    box-shadow: 0 8px 20px rgba(11,31,92,.22);
}
.toast-notification.toast-success.toast-connection { border-left-color: #10B981 !important; }
.toast-notification.toast-success.toast-connection .toast-icon { background: #10B981 !important; }
.toast-notification.toast-info.toast-disconnection { border-left-color: #F5B400 !important; }
.toast-notification.toast-info.toast-disconnection .toast-icon { background: #0B1F5C !important; }
.toast-notification .toast-title { color: #0B1F5C !important; font-size: 1.02rem !important; font-weight: 800 !important; }
.toast-notification .toast-message { color: #667085 !important; font-size: .88rem !important; }
.toast-notification .toast-close { color: #98A2B3 !important; }
...
@media (max-width: 480px) {
    ...
    .toast-notification .toast-icon { width: 42px; height: 42px; font-size: 1.15rem !important; }
}
