...
async function saveAllToSupabase() {
    if (!currentUser.wallet) {
        console.log("No user connected, save ignored");
        return false;
    }
    
    console.log("Saving all data to Supabase...");
    console.log("User:", currentUser.wallet);
...
async function saveUserToSupabase() {
    ...
    try {
        ...
        if (error) {
            ...
            console.log("User saved:", currentUser.wallet);
        }
    } catch (e) {
...
async function syncTicketsToSupabase() {
    try {
        if (tickets.length === 0) {
            console.log("No tickets to save");
            return;
        }
...
function createEvent(e) {
    ...
    renderEventsByCategory();
    updateProfilePage();
    alert('Event "' + newEvent.title + '" has been successfully published and saved!');
}

// ============================================================
// ===== MODIFIED CONFIRM PURCHASE =====
// ============================================================
...
// ============================================================
// ===== CONNEXION PI - AVEC CHARGEMENT DES DONNÉES =====
// ============================================================
